              ...
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li><a href="https://www.github.com" target="_blank" rel="noopener noreferrer" className="dropdown-item">GitHub</a></li>
                    <li>
                      <hr className="dropdown-divider"/>
                    </li>
                    <li><a href="https://ga-clippy.com" target="_blank" rel="noopener noreferrer" className="dropdown-item">Clippy</a></li>
                    <li>
                      <hr className="dropdown-divider"/>
                    </li>
                    <li><a href="https://developer.mozilla.org/" target="_blank" rel="noopener noreferrer" className="dropdown-item">MDN</a></li>
                  </ul>
                </li>
